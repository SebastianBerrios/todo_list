...
export default function TodoFormAdd() {
  const { addTodo, setOpenModalAddTodo } = useContext(TodoContext);
  ...
  return (
    ...
    >
      ...
      <textarea
        className="w-64 md:w-80 min-h-20 block p-2.5 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
        placeholder="Aqui escribe la descripción de tu TO-DO"
        value={newTodoValue}
        onChange={onChange}
      ></textarea>
